export function HomeAlt(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
...
export function ManWoman(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="50"
        ...
        >
            {/* <!--Boxicons v3.0 https://boxicons.com | License  https://docs.boxicons.com/free--> */}
            <path
                d="M6 2A2 2 0 1 0 6 6 2 2 0 1 0 6 2z">
            </path>
            <path
                d="m4,22h4v-7h2v-7c0-.55-.45-1-1-1H3c-.55,0-1,.45-1,1v7h2v7Z">
            </path>
            <path
                d="M17 2A2 2 0 1 0 17 6 2 2 0 1 0 17 2z">
            </path>
            <path
                d="m19,7h-4c-.45,0-.84.3-.96.73l-2,7,1.59.45-.63,2.82h2v4h4v-4h2l-.63-2.82,1.59-.45-2-7c-.12-.43-.52-.73-.96-.73Z"
            >
            </path>
        </svg>
    );
...
export function Dollar(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="50"
...
export function WhastApp(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
